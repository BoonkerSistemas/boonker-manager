...
export class CrearProyectoComponent implements OnInit {
    ...
    cargarDatos() {
        this._activosService.findOneById(this.idEdit).subscribe((data: any) => {
            ...
            this.clientRuc = data.ruc.name + ' ' + data.ruc.lastName;
        });
    }

    onClickGuardar(value: any) {
        if (this.crearFormGroup) {
            console.log(value);
            ...
            let insert: any = {
                ...
                startDate: this.datePipe
                    ...
                    .toString(),
                imageUrlDesktop: this.urlImagen ? this.urlImagen : 'defaul',
                createdUserId: this.idUsuario,
                targetUrl: '',
                ruc: this.clientRuc.ruc.name + ' ' +this.clientRuc.ruc.lastaName,
            };
